...
**Focus area (optional):** The user may invoke this as
`/design-gatekeeper <screen, component, or feature name>` — e.g.
`/design-gatekeeper checkout flow` or `/design-gatekeeper Button component`. If a
focus area is given, see Step 1.5 below for how to scope the search to it. If
none is given, audit the whole repo as normal.
